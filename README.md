...
может перемешаться с ней (без grab перехватить нечего); однобуквенные
слова «c», «r», «l» и т.п. чинятся в «с», «к», «д» — словарь допускает.
...
boundary_pause_ms  = 300 # пауза, после которой слово считается законченным
