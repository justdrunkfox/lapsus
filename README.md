...
- **Терминалы** не обновляют primary selection по Ctrl+Shift+Left, поэтому
  ...
  (Alacritty входит в дефолты, проверено вживую). Ограничение: вставка
  идёт в позицию курсора терминала, выделенный исходный текст не
  удаляется — шеллу выделение недоступно.
